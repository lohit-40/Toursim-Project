...
_fig_mon = px.bar(
    ...
    orientation="h",
    color="Total 2019", color_continuous_scale="Teal",
    text="Total 2019",
)
...
_fig_gen = go.Figure(go.Pie(
    ...
    values=[56.85, 43.14],
    hole=0.60,
    marker=dict(colors=[SKY, PINK], line=dict(color="#ffffff", width=3)),
...
layout = html.Div(className="perspective-container", children=[
    ...
    html.Div(className="content-3d-wrapper", children=[
        ...
        html.Div(className="stat-grid-3d", children=[
            ...
            _stat("📉",  "−72%",       "Drop: 2019 → 2020",         INDIGO),
            _stat("📈",  "+8.9%",      "India Growth 2024",         EMERALD),
            _stat("🏅",  "178",        "Protected Monuments",       PINK),
        ]),
